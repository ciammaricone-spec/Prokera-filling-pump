...
function Send-Command {
    ...
    try {
        ...
        Add-Log "Error enviando comando: $($_.Exception.Message)"
    }
}
...
function Read-Serial {
    ...
    try {
        ...
        Add-Log "Error leyendo serial: $($_.Exception.Message)"
    }
}
...
Update-DisplayValues
Set-ConnectedUi $false
Add-Log "Selecciona el COM del Arduino UNO y presiona Connect."
